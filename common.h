...
//    {0,  (H + (PW[1]*2)),          D[0], 1, 0}
  ...
  { 
    {2, (0 + (PW[11]*2)+D[5]+(PW[10]*2) + (PW[9]*2)+D[4]+(PW[8]*2)),    (PW[8]*2),  -1, 1},
    {2, (0 + (PW[11]*2)+D[5]+(PW[10]*2)),                               (PW[9]*2),   1, 1},
    {2, (0 + (PW[11]*2)+D[5]+(PW[10]*2)),                               (PW[10]*2), -1, 1},
    {2,  0,                                                             (PW[11]*2),  1, 1},
    {3, (H + (PW[15]*2)+D[7]+(PW[14]*2) + (PW[13]*2)+D[6]+(PW[12]*2)),  (PW[12]*2), -1, 1},
    {3, (H + (PW[15]*2)+D[7]+(PW[14]*2)),                               (PW[13]*2),  1, 1},
    {3, (H + (PW[15]*2)+D[7]+(PW[14]*2)),                               (PW[14]*2), -1, 1},
    {3,  H,                                                             (PW[15]*2),  1, 1},
    {4, 75, 75, -1, 1},
    {5, 75, 75, -1, 1},
    {6, 75, 75, -1, 1}
...
int LEVELS[11][2][5] = {
  { {0,      ((PW[3]*2) + D[1] + (PW[2]*2) + (PW[1]*2) + D[0]),   (PW[0]*2),  1, 1},    {2, (0 + (PW[11]*2)+D[5]+(PW[10]*2) + (PW[9]*2)+D[4]+(PW[8]*2)),    (PW[8]*2),  -1, 1} },
  { {0,      ((PW[3]*2) + D[1] + (PW[2]*2) + (PW[1]*2)),          (PW[1]*2), -1, 1},    {2, (0 + (PW[11]*2)+D[5]+(PW[10]*2)),                               (PW[9]*2),   1, 1} },
  { {0,      ((PW[3]*2) + D[1]),                                  (PW[2]*2),  1, 1},    {2, (0 + (PW[11]*2)+D[5]+(PW[10]*2)),                               (PW[10]*2), -1, 1} },
  { {0,       (PW[3]*2),                                          (PW[3]*2), -1, 1},    {2,  0,                                                             (PW[11]*2),  1, 1} },
  { {1,  (H + (PW[7]*2) + D[3] + (PW[6]*2) + (PW[5]*2) + D[2]),   (PW[4]*2),  1, 1},    {3, (H + (PW[15]*2)+D[7]+(PW[14]*2) + (PW[13]*2)+D[6]+(PW[12]*2)),  (PW[12]*2), -1, 1} },
  { {1,  (H + (PW[7]*2) + D[3] + (PW[6]*2) + (PW[5]*2)),          (PW[5]*2), -1, 1},    {3, (H + (PW[15]*2)+D[7]+(PW[14]*2)),                               (PW[13]*2),  1, 1} },
  { {1,  (H + (PW[7]*2) + D[3]),                                  (PW[6]*2),  1, 1},    {3, (H + (PW[15]*2)+D[7]+(PW[14]*2)),                               (PW[14]*2), -1, 1} },
  { {1,  (H + (PW[7]*2)),                                         (PW[7]*2), -1, 1},    {3,  H,                                                             (PW[15]*2),  1, 1} },
  { {4, 0, 75, 1, 1},                                                                   {4, 75, 75, -1, 1} },
  { {5, 0, 75, 1, 1},                                                                   {5, 75, 75, -1, 1} },
  { {6, 0, 75, 1, 1},                                                                   {6, 75, 75, -1, 1} }
};
