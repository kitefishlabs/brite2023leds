...
int PW[22] = {47,47,45,43,42,41,38,38, 100,98,94, 47,47,45,43,42,41,38,38, 100,98,94};
int H = 14;
...
int LEVELS[11][2][5] = {
  { {0,      ((PW[3]*2) + D[1] + (PW[2]*2) + (PW[1]*2) + D[0]),   (PW[0]*2),  1, 1},    {2, (0 + (PW[11+3]*2)+D[5]+(PW[10+3]*2) + (PW[9+3]*2)+D[4]+(PW[8+3]*2)),    (PW[8+3]*2),  -1, 1} },
  { {0,      ((PW[3]*2) + D[1] + (PW[2]*2) + (PW[1]*2)),          (PW[1]*2), -1, 1},    {2, (0 + (PW[11+3]*2)+D[5]+(PW[10+3]*2)),                                   (PW[9+3]*2),   1, 1} },
  { {0,      ((PW[3]*2) + D[1]),                                  (PW[2]*2),  1, 1},    {2, (0 + (PW[11+3]*2)+D[5]+(PW[10+3]*2)),                                   (PW[10+3]*2), -1, 1} },
  { {0,       (PW[3]*2),                                          (PW[3]*2), -1, 1},    {2,  0,                                                                     (PW[11+3]*2),  1, 1} },
  { {1,  (H + (PW[7]*2) + D[3] + (PW[6]*2) + (PW[5]*2) + D[2]),   (PW[4]*2),  1, 1},    {3, (H + (PW[15+3]*2)+D[7]+(PW[14+3]*2) + (PW[13+3]*2)+D[6]+(PW[12+3]*2)),  (PW[12+3]*2), -1, 1} },
  { {1,  (H + (PW[7]*2) + D[3] + (PW[6]*2) + (PW[5]*2)),          (PW[5]*2), -1, 1},    {3, (H + (PW[15+3]*2)+D[7]+(PW[14+3]*2)),                                   (PW[13+3]*2),  1, 1} },
  { {1,  (H + (PW[7]*2) + D[3]),                                  (PW[6]*2),  1, 1},    {3, (H + (PW[15+3]*2)+D[7]+(PW[14+3]*2)),                                   (PW[14+3]*2), -1, 1} },
  { {1,  (H + (PW[7]*2)),                                         (PW[7]*2), -1, 1},    {3,  H,                                                                     (PW[15+3]*2),  1, 1} },
